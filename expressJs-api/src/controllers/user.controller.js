...
const create = (req,res) =>{
    var {firstname,lastname,gender,userEmail,password,image_avarta,status} = req.body
    var message= {}
    ...
    var sqlInsert = "INSERT INTO `user`(`firstname`, `lastname`, `gender`, `userEmail`, `password`, `image_avarta`, `status`) VALUES (?,?,?,?,?,?,?)";
    var paramSql = [firstname,lastname,gender,userEmail,password,image_avarta,status]
...
const update = (req,res) =>{
    var {firstname,lastname,gender,userEmail,password,image_avarta,status,user_id} = req.body
    var message= {}
    if(isEmptyOrNull(firstname)){
        message.firstname = "please fill in firstname !"
    }
    ...
    var sqlUpdate = "UPDATE `user` SET `firstname`=?,`lastname`=?,`gender`=?,`userEmail`=?,`password`=?,`image_avarta`=?,`status`=? WHERE `user_id`=?";
    var paramSql = [firstname,lastname,gender,userEmail,password,image_avarta,status,user_id]
